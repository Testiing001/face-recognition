...
export const ConfirmModal = () => {
    ...
    return (
        <div className="fixed inset-0 flex bg-black/40 items-center justify-center z-5">
            <div className="bg-white rounded-xl px-8 py-6 shadow-lg w-md flex flex-col gap-4">
