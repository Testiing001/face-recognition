    ...
    return (
        <>
            <button
                ...
                className="flex items-center gap-1 my-1 ml-[-16px] md:mt-1 mt-15 text-lg text-gray-500 hover:text-gray-700 hover:bg-gray-200 px-2 py-1 rounded-xl hover:scale-105 font-semibold cursor-pointer transition"
                >
            ...
            {selectedGroup.photos.length > 0 ? ( 
                ...
                <>
                    <div className="min-h-[85vh] flex items-center justify-center">
                        <p className="text-gray-500 text-lg font-semibold">No photos in group</p>
                    </div>  
                </>
            )}
        </>
